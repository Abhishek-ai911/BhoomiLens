                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap text-right">
                        <div className="inline-flex items-center gap-1.5">
                          ...
                          <Link
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-bold bg-emerald-600 text-white hover:bg-emerald-500 transition-colors shadow-sm"
                          >
                            <span>Inspect</span>
                          ...
                          <div className="bg-white rounded-lg p-4 border border-slate-200 shadow-sm space-y-3">
                            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <Link
                                  href={`/dashboard/cases/${item.case_id}`}
                                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 transition"
                                >
                                  <span>Open Parcel GIS & Detail</span>
